...
const SEED_FACILITIES = [
  ...
  { id: "shibuya-pc", name: "NEON PICKLEBALL CLUB", area: "渋谷区", lat: 35.6632, lng: 139.6991, indoor: true, live: false, cat: "dedicated", plans: [courtPlan("shibuya-pc", 5500, "¥5,500/h〜")], rating: "期間限定・ネオン演出", url: "https://shibuya-rental.space/", note: "宇田川町・渋谷東武ホテルB2Fのブラックライト演出コート2面・2026年8月8日グランドオープン（SHIBUYA PICKLEBALL CLUB会員制と併設）・ホテル閉業に伴い2027年2月末で閉館予定" },
  ...
  /* ---- 2026-09 追加調査で判明した施設 ---- */
  { id: "picklr-makuhari", name: "PICKLR幕張", area: "千葉市美浜区", lat: 35.647, lng: 140.035, indoor: true, live: false, cat: "dedicated", plans: [courtPlan("picklr-makuhari", 3000, "要問合せ")], rating: "PICKLR日本上陸パイロット店", url: "https://makuharishintoshin.aeonmall.jp/shop/7302607e-71a7-4d54-822b-299669c87bf9", note: "イオンモール幕張新都心Active Mall1F・世界No.1ブランドPICKLRの先行パイロット店・2026年4月25日オープン、2026年11月末までの期間限定営業（豊洲本店の先行版）" },
  { id: "pickleball-park-toyosu", name: "PICKLEBALL PARK TOYOSU", area: "江東区豊洲", lat: 35.652, lng: 139.793, indoor: false, live: false, cat: "dedicated", plans: [
      { id: "pb-park-toyosu-wd", name: "コート貸切（平日）", kind: "court", price: 6000, unit: "1h", capacity: null },
      { id: "pb-park-toyosu-we", name: "コート貸切（土日祝）", kind: "court", price: 8000, unit: "1h", capacity: null },
    ], rating: "2026年9月オープン", url: "https://toyosu.pickle-one.com/", note: "THE DOG PARK TOYOSU内（三井不動産・TBS）・屋外ハード4面・新豊洲駅3分・朝6時〜夜10時営業・2026年9月9日オープン（ピックルボールワン運営）" },
  { id: "izu-resort-villa", name: "伊豆リゾートヴィラ ピックルボールコート", area: "賀茂郡東伊豆町", lat: 34.886, lng: 139.121, indoor: false, live: false, cat: "trip", plans: [courtPlan("izu-resort-villa", 3000, "要問合せ")], rating: "国内最大級20面", url: "https://izu-resort-villa.com/", note: "稲取・旧テニスコートを転用した専用コート群（まず6面稼働、2027年に44面へ拡大予定）・2026年7月20日オープン・ルスツリゾートと同じ加森観光運営", resort: true },
  { id: "yatsugatake-resort", name: "グランドメルキュール八ヶ岳リゾート&スパ ピックルボールコート", area: "北杜市", lat: 35.886, lng: 138.39, indoor: false, live: false, cat: "trip", plans: [courtPlan("yatsugatake-resort", 3000, "宿泊者無料")], rating: "屋外専用6面", url: "https://grand-mercure-yatsugatake-resortandspa.jp/plan/pickleball/", note: "北杜市・屋外専用6面が2026年8月10日グランドオープン・宿泊料金内でレンタル込み", resort: true },
  { id: "agora-sakai", name: "ホテルアゴーラ・リージェンシー大阪堺 ピックルボールコート", area: "堺市堺区", lat: 34.583, lng: 135.433, indoor: true, live: false, cat: "conv", plans: [courtPlan("agora-sakai", 3000, "要問合せ")], rating: "屋内6面", url: "https://www.agoraregency-sakai.com/", note: "堺駅直結ホテル6F・屋内6面・2026年4月25日オープン・更衣室完備・8:00-22:00無休（ファンダメンタルジャパン運営）" },
];
